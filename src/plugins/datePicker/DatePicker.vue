  ...
  export default {
    ...
    computed: {
      dateList () {
        ...
        let dateList = Array.from({length: currentMonthLength}, function (val, index) {
          return {
            currentMonth: true,
            value: index + 1
          }
...
<style rel="stylesheet/scss" lang="scss">
  ...
  div.date-picker {
    ...
    .date-panel {
      ...
      .type-year .year-list, .type-month .month-list {
        display: flex;
        flex-flow: row wrap;
        justify-content: space-between;
        li {
